...
//     version 1.4.4
//     from Assets/Scripts/Shooters/ItemHandler.inputactions
//
...
public partial class @ItemHandler : IInputActionCollection2, IDisposable
{
    ...
    private IScrollActions m_ScrollActionsCallbackInterface;
    ...
    public struct ScrollActions
    {
        ...
        {
            if (m_Wrapper.m_ScrollActionsCallbackInterface != null)
            {
                @Scroll.started -= m_Wrapper.m_ScrollActionsCallbackInterface.OnScroll;
                @Scroll.performed -= m_Wrapper.m_ScrollActionsCallbackInterface.OnScroll;
                @Scroll.canceled -= m_Wrapper.m_ScrollActionsCallbackInterface.OnScroll;
            }
            m_Wrapper.m_ScrollActionsCallbackInterface = instance;
            if (instance != null)
            {
    ...
    private IUsageActions m_UsageActionsCallbackInterface;
    ...
    public struct UsageActions
    {
        ...
        {
            if (m_Wrapper.m_UsageActionsCallbackInterface != null)
            {
                @Shoot.started -= m_Wrapper.m_UsageActionsCallbackInterface.OnShoot;
                @Shoot.performed -= m_Wrapper.m_UsageActionsCallbackInterface.OnShoot;
                @Shoot.canceled -= m_Wrapper.m_UsageActionsCallbackInterface.OnShoot;
                @Aim.started -= m_Wrapper.m_UsageActionsCallbackInterface.OnAim;
                @Aim.performed -= m_Wrapper.m_UsageActionsCallbackInterface.OnAim;
                @Aim.canceled -= m_Wrapper.m_UsageActionsCallbackInterface.OnAim;
            }
            m_Wrapper.m_UsageActionsCallbackInterface = instance;
            if (instance != null)
            {
